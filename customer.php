						...
						<form role="form" class="form-horizontal form-groups-bordered" id="form" method="post" enctype="multipart/form-data">
							<div class="col-sm-12 row">
								<div class="form-group col-sm-6">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="customer_id" name="customer_id" style="border: 1px solid #ccc;" autocomplete="off" value="<?php echo $digit; ?>" readonly="">
									</div>
								</div>
								...
								<div class="form-group col-sm-6">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Customer Name" style="border: 1px solid #ccc;" autocomplete="off" value="" required="">
							...
							<div class="col-sm-12 row">
								<div class="form-group col-sm-6">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="phone" name="phone" placeholder="Phone No." style="border: 1px solid #ccc;" autocomplete="off" value="" required="">
									...
									<div class="form-group col-sm-6">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="address" name="address" placeholder="Address" style="border: 1px solid #ccc;" autocomplete="off" value="" required="">
							...
							<div class="col-sm-12 row">
								<div class="form-group col-sm-6">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="email" name="email" placeholder="Email Address" style="border: 1px solid #ccc;" autocomplete="off" value="">
