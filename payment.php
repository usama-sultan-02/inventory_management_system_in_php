						...
						<form role="form" class="form-horizontal form-groups-bordered" id="form" method="post" enctype="multipart/form-data">
							...
							<div class="col-sm-12 row">
								<div class="form-group col-sm-6">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control amount" id="debit" name="debit" placeholder="Debit" style="border: 2px solid #ccc;" autocomplete="off" value="0" required="">
									...
									<div class="form-group col-sm-6">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" id="credit" name="credit" placeholder="Credit" style="border: 2px solid #ccc;" autocomplete="off" value="0" required="">
							...
							<div class="col-sm-12 row">
								<div class="form-group col-sm-6">
									...
									<div class="col-sm-8">
										<div class="input-group">
											<input type="text" class="form-control datepicker" data-format="dd-m-yyyy" style="border: 2px solid #ccc;" placeholder="Select Date" id="date" name="date" autocomplete="off" required>
											
											<div class="input-group-addon" style="border: 2px solid #ccc;">
								...
								<div class="form-group col-sm-6">
									...
									<div class="col-sm-8">
										<textarea class="form-control" id="description" name="description" placeholder="Item Description" style="border: 2px solid #ccc;" rows="4" required></textarea>
...
<script>
	$(document).ready(function(){
		...
		// jQuery("#debit").inputmask({"mask": "999999999"});

		// $(".amount").keyup(function(){
		// 	//var debit=$("#debit").val();
		// 	var debit=$("#debit").val("/^(\d{4}))$/");
		// 	// /^(\d{4})(\d{4})$/

		// 	//$('input[class="amount"]').mask('000000000');
