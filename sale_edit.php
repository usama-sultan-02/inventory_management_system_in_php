						...
						<form role="form" class="form-horizontal form-groups-bordered" id="form" method="post" enctype="multipart/form-data">
							...
							<div class="col-sm-12 row">
								<div class="form-group col-sm-6">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="unit_price" name="unit_price" placeholder="Unit Price" style="border: 1px solid #ccc;" autocomplete="off" value="" required="">
									...
									<div class="form-group col-sm-6">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" id="total_price" name="total_price" placeholder="Total Price" style="border: 1px solid #ccc;" required="" readonly>
							...
							<?php 
							include('conn.php');
								$customer_name_query= mysqli_query($conn, "SELECT * FROM `customer` WHERE `customer_id`='$sale_to'");
								while ($r=mysqli_fetch_array($customer_name_query)){
								...
								<div class="form-group col-sm-6">
									...
									<div class="col-sm-8" id="sale_to_div">
										...
										<select name="sale_to" id="sale_to" class="select2" data-allow-clear="true" data-placeholder="Select Customer" style="" required>
											...
											<option value="<?php echo $sale_to; ?>"><?php echo $cust; ?></option>
...
if (isset($_POST['submit'])){
	...
	$sql="INSERT INTO `sale` (`id`, `sale_id`, `date`, `sale_to`) VALUES (NULL, '$sale_code', '$date', '$sale_to')";
...
<script type="text/javascript">
  ...
  //$("#add_item").change(function(){
	...
	$("#test").click(function(e){
		...
		//$('#s_ed').on({'click': function(){
			$("#test").click(function(e){

			alert('sale item edit');
				var sale_code=$("#sale_code").val();
				var id = $(this).attr("id");
				...
				$.ajax({
					url:"ajax.php",
					method:"POST",
					data:{sale_item_edit:id, sale_id_on_sale_item_edit:sale_code},
					success:function(data){
			...
			$('#print').on({'click': function(){
					...
					$.ajax({
				     ...
				     success:function(data){
			            ...
			            // $('#invoice_table_body').val(dataa[0]);
			            // $('#invoice_sub_total').val(dataa[1]);


						    // var result = $.parseJSON(data);

						    // $('#invoice_table_body').html(result.table);
						    // alert('result.table');
						    // $('#invoice_sub_total').html(result.inv_total_price);
						//}
