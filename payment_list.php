...
<?php
	...
	<tr>
            ...
            <?php   $total_balance=$total_balance+$debit;
					$total_balance=$total_balance-$credit;     ?>
            <td><?php echo $total_balance; ?></td>
            <td>
                    	<a href="payment_edit.php?payment_id=<?php echo $row['id']; ?>" name="edit" id="" class="btn btn-default btn-sm btn-icon icon-left">
