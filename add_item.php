						...
						<form role="form" class="form-horizontal form-groups-bordered" id="form" method="post" enctype="multipart/form-data">
							<div class="col-sm-12 row">
								<div class="form-group col-sm-6">
									<label class="col-sm-4 control-label" style="text-align: left;">Item Code</label>
							...
							<div class="col-sm-12 row">
								<div class="form-group col-sm-6">
									...
									<div class="form-group col-sm-6">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" id="price" name="price" placeholder="Price" style="border: 1px solid #ccc;" autocomplete="off" value="" required="">
							...
							<div class="col-sm-12 row">
								<div class="form-group col-sm-6">
									<label class="col-sm-4 control-label" style="text-align: left;">Item Description</label>
								...
								<div class="form-group col-sm-6">
									...
									<div class="col-sm-4" id="img">
						                ...
						                <input type="file" name="fileToUpload" id="upload_image" class="btn" accept=".png, .jpg, .jpeg" required="">
										...
										<!-- <img src="assets/media/users/blank.png" style="height: 100px; width: 100px;" id="image_show" class="img-thumbnail rounded mx-auto d-block" />
...
if (isset($_POST['submit'])){
	...
	$sql="INSERT INTO `items` (`id`, `item_code`, `item_name`, `date`, `price`, `item_description`, `item_image`) VALUES (NULL, '$digit', '$item_name', '$date', '$price', '$item_description', '$name');";
