						...
						<form role="form" class="form-horizontal form-groups-bordered" id="form" method="post" enctype="multipart/form-data">
							<div class="col-sm-12 row">
								<div class="form-group col-sm-6">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="sale_code" name="sale_code" style="border: 1px solid #ccc;" autocomplete="off" value="<?php echo $digit; ?>" readonly="">
									</div>
								</div>
...
<script type="text/javascript">
  ...
  //$("#add_item").change(function(){
   	$("#add_item").click(function(e){
			...
			//$('#calender_icon').attr('disabled', true);
			//$('#date_input_group').attr('disabled', true);

			//$("#date").datepicker({minDate:-1,maxDate:-2}).attr('readonly','readonly');  
			
			// $("#date").datepicker("option", "minDate", -1);
			// $("#date").datepicker("option", "maxDate", -2); 
			
			//$("#date").readonlyDatepicker(true); //makes the datepicker readonly
			//$('#date').attr('readonly', true);
